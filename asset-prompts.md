...
> **공통 스타일 앵커** (모든 프롬프트에 공통 적용):
> - 캐릭터: `soft watercolor illustration, warm kawaii style, rounded features, gentle pastel palette, clean white background for cutout, 1:1 square, no text, no watermark`
> - 시설/배경/건물: `soft watercolor illustration, gentle pastel palette, warm kawaii-adjacent style, no text, no watermark`
> - 뱃지/아이콘: `game icon, clean transparent background, 1:1 square, no text, no watermark`
>
> **Negative prompt** (모든 생성에 공통 적용):
> `text, watermark, signature, logo, realistic photo, 3d render, scary, horror, violence, blood, self-harm, nudity, deformed, blurry, low quality`
>
> **해상도 기준**:
> - 캐릭터 아바타: 256×256px (1:1)
> - 시설 일러스트: 512×384px (4:3)
> - 층 배경: 1920×1080px (16:9)
> - 센터 외관: 800×600px (4:3)
> - 컷씬/이벤트: 1280×720px (16:9)
> - 업적 뱃지: 128×128px (1:1)
> - UI 아이콘: 128×128px (1:1)
>
> **포맷**: 생성 후 Squoosh(squoosh.app)에서 WebP 변환 (품질 80%)
>
> **윤리 가이드라인**:
> - 자해/폭력/공포 장면 절대 불가
...
: `soft watercolor illustration, gentle pastel palette, a counseling room interior, level 2 upgrade, spacious room with comfortable sofa replacing basic chairs, warm wooden side table, soft floor lamp, calming artwork on wall, improved cozy atmosphere, professional psychology office, 4:3 aspect ratio, warm palette`

(2) `individual_room_lv3.webp`
: `soft watercolor illustration, gentle pastel palette, a premium counseling room interior, level 3 luxury upgrade, designer leather armchair and sofa, built-in bookshelf wall, ambient indirect lighting, indoor plant corner, sound-dampening panels, high-end therapy office, 4:3 aspect ratio, warm golden palette`

### 2) 집단상담실 (group_room)

(3) `group_room_lv2.webp`
: `soft watercolor illustration, gentle pastel palette, a group therapy room interior, level 2 upgrade, circular cushion seating with comfortable floor cushions, whiteboard and flip chart, soft carpet, improved lighting, warm communal atmosphere, 4:3 aspect ratio, violet-toned palette`

(4) `group_room_lv3.webp`
: `soft watercolor illustration, gentle pastel palette, a premium group therapy room, level 3 luxury, modular comfortable chairs in circle, digital display board, acoustic panels on walls, multi-zone lighting, premium materials, professional group counseling space, 4:3 aspect ratio, violet-toned palette`

### 3) 노출치료실 (exposure_lab)

(5) `exposure_lab_lv2.webp`
: `soft watercolor illustration, gentle pastel palette, an exposure therapy lab interior, level 2 upgrade, VR headset station added, graduated exposure tools, monitoring screens, controlled environment chamber, clinical but reassuring design, 4:3 aspect ratio, amber-toned palette`

(6) `exposure_lab_lv3.webp`
: `soft watercolor illustration, gentle pastel palette, an advanced exposure therapy lab, level 3 high-tech, full VR immersion station, biofeedback monitors, multiple simulation rooms visible, cutting-edge therapeutic technology, professional and sophisticated, 4:3 aspect ratio, amber-toned palette`

### 4) 마음챙김실 (mindfulness_room)

(7) `mindfulness_room_lv2.webp`
: `soft watercolor illustration, gentle pastel palette, a mindfulness room interior, level 2 upgrade, meditation cushions with ambient LED color lamps, small water fountain, aromatherapy diffuser, sound bowls, improved zen atmosphere, 4:3 aspect ratio, teal-toned palette`

(8) `mindfulness_room_lv3.webp`
: `soft watercolor illustration, gentle pastel palette, a premium mindfulness sanctuary, level 3 luxury, natural skylight with real sunlight, indoor rock garden with flowing water feature, floor-to-ceiling nature mural, premium meditation space, 4:3 aspect ratio, teal and green palette`

### 5) 가족상담실 (family_room)

(9) `family_room_lv2.webp`
: `soft watercolor illustration, gentle pastel palette, a family therapy room interior, level 2 upgrade, large comfortable sectional sofa, children's play corner added, family art supplies, warm homey atmosphere, two-zone design for adults and kids, 4:3 aspect ratio, pink-toned palette`

(10) `family_room_lv3.webp`
: `soft watercolor illustration, gentle pastel palette, a premium family therapy suite, level 3, observation room with one-way mirror, separate children's therapy wing, family interaction space, professional family therapy equipment, modern warm design, 4:3 aspect ratio, pink-toned palette`

### 6) 활동치료실 (activity_room)

(11) `activity_room_lv2.webp`
: `soft watercolor illustration, gentle pastel palette, an activity therapy room, level 2 upgrade, art supplies plus music instruments corner, exercise area with yoga mats, creative expression wall, multi-activity design, 4:3 aspect ratio, green-toned palette`

(12) `activity_room_lv3.webp`
: `soft watercolor illustration, gentle pastel palette, a comprehensive activity therapy center, level 3, full art studio section, music therapy corner with piano, movement therapy space with mirrors, pottery wheel, premium creative healing space, 4:3 aspect ratio, green-toned palette`
...
(1) `play_room.webp`
: `soft watercolor illustration, gentle pastel palette, a child play therapy room, bright cheerful colors, toy shelves neatly organized, sand tray therapy table, dollhouse, art corner with crayons, soft carpet floor, warm inviting atmosphere for children age 7-12, 4:3 aspect ratio, yellow and warm palette`

(2) `play_room_lv2.webp`
: `soft watercolor illustration, gentle pastel palette, upgraded child play therapy room, expanded toy collection, puppet theater corner, sensory play station, improved lighting with colorful pendants, larger sand tray with figurines collection, 4:3 aspect ratio, yellow and warm palette`

(3) `play_room_lv3.webp`
: `soft watercolor illustration, gentle pastel palette, premium child play therapy suite, multiple themed play zones, professional puppet stage, digital interactive play wall, art therapy studio section, top-quality therapeutic toys, dream playroom for healing, 4:3 aspect ratio, yellow and warm palette`

(4) `play_room_interior.webp`
: `watercolor illustration wide view of play therapy room interior, child sitting on floor surrounded by therapeutic toys, sand tray visible, puppets on shelf, warm afternoon light through window, inviting and safe, 4:3 aspect ratio`

### 2) 부모상담실 (parent_room)

(5) `parent_room.webp`
: `soft watercolor illustration, gentle pastel palette, a parent consultation room, comfortable sofa and armchair, warm lamp lighting, tissue box and coffee table, family photos display concept, warm orange-toned cozy room, professional but homey, 4:3 aspect ratio`

(6) `parent_room_lv2.webp`
: `soft watercolor illustration, gentle pastel palette, upgraded parent consultation room, larger comfortable seating area, parenting resource bookshelf, calming artwork, improved sound insulation panels, better lighting, 4:3 aspect ratio, orange-toned palette`

(7) `parent_room_lv3.webp`
: `soft watercolor illustration, gentle pastel palette, premium parent consultation suite, video conferencing setup for remote parents, comprehensive parenting library, separate private meeting nook, beverage station, luxurious comfort, 4:3 aspect ratio, orange-toned palette`

(8) `parent_room_interior.webp`
: `watercolor illustration wide view of parent consultation room, two adults sitting on comfortable sofa in deep conversation, warm lamplight, coffee cups on table, supportive atmosphere, 4:3 aspect ratio`

### 3) 사회기술훈련실 (group_activity)

(9) `group_activity.webp`
: `soft watercolor illustration, gentle pastel palette, social skills training room for children, circular mat seating, board games and social skills cards on shelves, cooperation activity posters, bright indigo-toned room, interactive whiteboard, 4:3 aspect ratio`

(10) `group_activity_lv2.webp`
: `soft watercolor illustration, gentle pastel palette, upgraded social skills room, role-play costume corner, video recording setup for social skills practice, expanded game collection, improved group activity space, 4:3 aspect ratio, indigo palette`

(11) `group_activity_lv3.webp`
: `soft watercolor illustration, gentle pastel palette, premium social skills center, simulated real-world scenarios setup (mock store, school), advanced social interaction tools, observation gallery, professional group therapy space for children, 4:3 aspect ratio, indigo palette`

(12) `group_activity_interior.webp`
: `watercolor illustration wide view of social skills room, children sitting in circle on colorful mats playing cooperative board game, facilitator guiding, cheerful atmosphere, 4:3 aspect ratio`

### 4) 아동노출치료실 (exposure_child)

(13) `exposure_child.webp`
: `soft watercolor illustration, gentle pastel palette, child-friendly exposure therapy room, graduated difficulty steps visualized on wall, comfort items basket, brave star reward chart, gentle clinical design with warm colors, child-safe equipment, 4:3 aspect ratio, amber palette`

(14) `exposure_child_lv2.webp`
: `soft watercolor illustration, gentle pastel palette, upgraded child exposure therapy room, tablet-based virtual exposure tools, expanded comfort corner with weighted blankets, child-sized relaxation station, improved step-by-step visual guides, 4:3 aspect ratio, amber palette`

(15) `exposure_child_lv3.webp`
: `soft watercolor illustration, gentle pastel palette, advanced child exposure therapy suite, child-friendly VR system, multiple themed exposure chambers, comprehensive reward system display, biofeedback monitor with kid-friendly interface, 4:3 aspect ratio, amber palette`

(16) `exposure_child_interior.webp`
: `watercolor illustration wide view of child exposure room, child bravely approaching feared stimulus with therapist support, step ladder metaphor on wall, warm encouraging atmosphere, 4:3 aspect ratio`

### 5) 영양치료실 (nutrition_clinic)

(17) `nutrition_clinic.webp`
: `soft watercolor illustration, gentle pastel palette, nutrition therapy clinic for eating disorders, healthy food posters, meal planning table, gentle weighing corner with curtain for privacy, warm lime-green palette, supportive non-judgmental design, 4:3 aspect ratio`

(18) `nutrition_clinic_lv2.webp`
: `soft watercolor illustration, gentle pastel palette, upgraded nutrition clinic, cooking therapy corner, meal practice kitchenette, body-positive artwork, nutritional education display, improved private consultation area, 4:3 aspect ratio, lime-green palette`

(19) `nutrition_clinic_lv3.webp`
: `soft watercolor illustration, gentle pastel palette, premium nutrition therapy center, full therapeutic kitchen, family meal practice dining room, garden therapy windowsill herbs, comprehensive recovery-focused environment, 4:3 aspect ratio, lime-green palette`

(20) `nutrition_clinic_interior.webp`
: `watercolor illustration wide view of nutrition clinic, teen sitting at table with meal plan worksheet, healthy food display nearby, warm supportive atmosphere, no focus on weight or body, 4:3 aspect ratio`

### 6) 위기개입실 (crisis_room)

(21) `crisis_room.webp`
: `soft watercolor illustration, gentle pastel palette, crisis intervention room for youth, safety-padded soft walls in warm colors, calming sensory tools basket, safety plan poster, bean bag chairs, de-escalation space, warm red-toned but NOT scary, safe haven design, 4:3 aspect ratio`

(22) `crisis_room_lv2.webp`
: `soft watercolor illustration, gentle pastel palette, upgraded crisis room, improved sensory modulation tools, weighted blankets and compression items, calming light projector, direct phone line, enhanced safety features, 4:3 aspect ratio, warm red palette`

(23) `crisis_room_lv3.webp`
: `soft watercolor illustration, gentle pastel palette, advanced crisis intervention suite, multi-sensory regulation room, real-time monitoring system with gentle interface, separate cool-down zones, connection to emergency services panel, highest safety standards, 4:3 aspect ratio, warm red palette`

(24) `crisis_room_interior.webp`
: `watercolor illustration wide view of crisis room, safe cozy space with soft lighting, sensory tools visible, calming projector on ceiling showing gentle waves, atmosphere of safety and containment, 4:3 aspect ratio`
...
(1) `infant_play.webp`
: `soft watercolor illustration, gentle pastel palette, infant developmental play room, soft foam mat floor, baby-safe developmental toys, wall mirror at child height, mobile hanging from ceiling, pastel pink and warm palette, safe nurturing environment for ages 1-5, 4:3 aspect ratio`

(2) `infant_play_lv2.webp`
: `soft watercolor illustration, gentle pastel palette, upgraded infant play room, expanded developmental toy collection, cause-and-effect toys station, imitation play corner with child-sized kitchen, improved safety padding, 4:3 aspect ratio, soft pink palette`

(3) `infant_play_lv3.webp`
: `soft watercolor illustration, gentle pastel palette, premium infant developmental play suite, multiple themed play zones, water play station, natural material sensory corner, garden-view window, highest quality developmental environment, 4:3 aspect ratio, soft pink palette`

(4) `infant_play_interior.webp`
: `watercolor illustration wide view of infant play room, toddler exploring toys on soft mat, colorful mobiles overhead, warm sunlight, nurturing atmosphere, 4:3 aspect ratio`

### 2) 감각통합실 (sensory_room)

(5) `sensory_room.webp`
: `soft watercolor illustration, gentle pastel palette, sensory integration room, bubble tube column, tactile wall panels, suspended therapy swing, ball pit corner, soft colored LED lighting, purple-toned calming space, therapeutic sensory environment, 4:3 aspect ratio`

(6) `sensory_room_lv2.webp`
: `soft watercolor illustration, gentle pastel palette, upgraded sensory room, expanded swing collection including platform swing, fiber optic ceiling lights, vibrating cushion station, scent therapy corner, 4:3 aspect ratio, purple palette`

(7) `sensory_room_lv3.webp`
: `soft watercolor illustration, gentle pastel palette, premium multisensory environment, interactive light-up floor, projection mapping walls, full Snoezelen room features, professional-grade sensory integration equipment, 4:3 aspect ratio, purple palette`

(8) `sensory_room_interior.webp`
: `watercolor illustration wide view of sensory room, child on therapy swing with gentle lighting from bubble tubes, calm dreamy atmosphere, 4:3 aspect ratio`

### 3) 부모코칭실 (parent_coaching)

(9) `parent_coaching.webp`
: `soft watercolor illustration, gentle pastel palette, parent coaching room, one-way observation mirror, earpiece coaching setup, comfortable parent viewing area, child play space visible through mirror, professional coaching environment, orange-toned palette, 4:3 aspect ratio`

(10) `parent_coaching_lv2.webp`
: `soft watercolor illustration, gentle pastel palette, upgraded coaching room, live video feed system, split-screen coaching monitor, improved earpiece technology, resource library shelf, 4:3 aspect ratio, orange palette`

(11) `parent_coaching_lv3.webp`
: `soft watercolor illustration, gentle pastel palette, advanced parent coaching suite, multi-camera observation system, real-time behavioral coding display, recording and playback station, comprehensive parent training center, 4:3 aspect ratio, orange palette`

(12) `parent_coaching_interior.webp`
: `watercolor illustration wide view of coaching room, parent watching child play through one-way mirror while receiving guidance through earpiece, warm supportive atmosphere, 4:3 aspect ratio`

### 4) 언어치료실 (language_lab)

(13) `language_lab.webp`
: `soft watercolor illustration, gentle pastel palette, speech and language therapy room, picture communication cards on wall, AAC device on table, picture books shelf, recording equipment, child-friendly acoustic design, cyan-toned palette, 4:3 aspect ratio`

(14) `language_lab_lv2.webp`
: `soft watercolor illustration, gentle pastel palette, upgraded language lab, interactive touchscreen word board, expanded AAC device collection, puppet theater for narrative therapy, sound-dampened recording booth, 4:3 aspect ratio, cyan palette`

(15) `language_lab_lv3.webp`
: `soft watercolor illustration, gentle pastel palette, premium language therapy center, speech analysis software display, comprehensive AAC technology wall, immersive storytelling corner, professional speech pathology equipment, 4:3 aspect ratio, cyan palette`

(16) `language_lab_interior.webp`
: `watercolor illustration wide view of language therapy room, therapist and child at table with picture cards, child pointing at communication board, warm engaging atmosphere, 4:3 aspect ratio`

### 5) 구조화교실 (structured_teaching)

(17) `structured_teaching.webp`
: `soft watercolor illustration, gentle pastel palette, TEACCH structured teaching classroom, visual schedule on wall, individual work stations with dividers, labeled bins and task systems, clear spatial organization, blue-toned professional space, 4:3 aspect ratio`

(18) `structured_teaching_lv2.webp`
: `soft watercolor illustration, gentle pastel palette, upgraded structured classroom, expanded individual work stations, digital visual schedule system, token economy reward display, improved visual supports, 4:3 aspect ratio, blue palette`

(19) `structured_teaching_lv3.webp`
: `soft watercolor illustration, gentle pastel palette, advanced structured teaching center, multiple specialized zones, comprehensive visual support systems, data collection technology, professional ABA/TEACCH environment, 4:3 aspect ratio, blue palette`

(20) `structured_teaching_interior.webp`
: `watercolor illustration wide view of structured classroom, child working at organized station following visual schedule, clear and predictable environment, calm focused atmosphere, 4:3 aspect ratio`
...
: `watercolor illustration wide view of individual counseling room, two comfortable chairs facing each other, soft lamp between them, bookshelf in background, therapy in session atmosphere, warm inviting, 4:3 aspect ratio`

(2) `group_room_interior.webp`
: `watercolor illustration wide view of group therapy room, circle of chairs with one facilitator position, whiteboard with notes, warm communal atmosphere, afternoon light, 4:3 aspect ratio`

(3) `exposure_lab_interior.webp`
: `watercolor illustration wide view of exposure therapy lab, graduated exposure setup, monitoring station, controlled environment, clinical but supportive, 4:3 aspect ratio`

(4) `mindfulness_room_interior.webp`
: `watercolor illustration wide view of mindfulness meditation room, meditation cushions in circle, small fountain, incense holder, natural light from skylight, peaceful zen atmosphere, 4:3 aspect ratio`

(5) `family_room_interior.webp`
: `watercolor illustration wide view of family therapy room, large sectional sofa, children's play corner, family interaction space, warm homey but professional, 4:3 aspect ratio`

(6) `activity_room_interior.webp`
: `watercolor illustration wide view of activity therapy room, art supplies station, music instruments corner, yoga mats area, creative expression space, colorful and energetic, 4:3 aspect ratio`
...
(1) `child_garden.webp`
: `wide panoramic watercolor illustration, 16:9, sky playground rooftop space, bright blue sky with fluffy clouds, rainbow slide and climbing structure, colorful flower beds, children's garden with butterflies, warm golden sunlight, amber-yellow color scheme, joyful healing space for recovered children, no people`

(2) `child_comfort.webp`
: `wide panoramic watercolor illustration, 16:9, cozy counseling room hallway for children, soft violet-lavender color scheme, comfortable reading nooks along walls, stuffed animals on shelves, fairy lights on ceiling, warm carpet floor, safe nurturing atmosphere, no people`

(3) `child_care.webp`
: `wide panoramic watercolor illustration, 16:9, children's care center corridor, sky-blue color scheme, school-like but warmer atmosphere, colorful doors with different therapy room signs, children's artwork displayed on walls, bright natural lighting, no people`

(4) `child_intensive.webp`
: `wide panoramic watercolor illustration, 16:9, intensive care unit for children, warm orange color scheme, professional but child-friendly, specialized therapy rooms visible, calming ocean murals on walls, structured environment, no people`

(5) `child_shelter.webp`
: `wide panoramic watercolor illustration, 16:9, protective treatment center for children, soft red-coral color scheme, maximum safety design, padded corners, cozy protected spaces, night-light atmosphere with warm glowing lamps, feeling of safety and containment, no people`
...
(1) `infant_bloom.webp`
: `wide panoramic watercolor illustration, 16:9, blooming playroom for toddlers, soft green pastel color scheme, flower motifs on walls, hanging colorful mobiles, soft foam mat floor, natural sunlight through large windows, gentle nursery plants, magical garden-like atmosphere, no people`

(2) `infant_nurture.webp`
: `wide panoramic watercolor illustration, 16:9, warm nurturing care room for infants, soft rose-pink color scheme, rocking chairs, cozy cushion corners, gentle night-sky ceiling with stars, warm blankets draped over furniture, womb-like safe atmosphere, no people`

(3) `infant_care.webp`
: `wide panoramic watercolor illustration, 16:9, developmental support center for toddlers, soft blue pastel color scheme, developmental assessment tools neatly arranged, educational play stations, height-appropriate furniture, organized and stimulating, no people`

(4) `infant_cocoon.webp`
: `wide panoramic watercolor illustration, 16:9, safe cocoon sanctuary for infants, soft purple-lavender color scheme, nest-like enclosed spaces, weighted blankets visible, gentle heartbeat-rhythm lighting, maximum comfort and protection, womb-safe atmosphere, no people`
...
(1) `center_f.webp`
: `soft watercolor illustration, gentle pastel palette, small run-down counseling office building, cracked walls, faded sign barely readable, weeds growing around entrance, single dim window light, rainy gloomy atmosphere, old residential building converted to office, humble beginnings, 4:3 aspect ratio`

(2) `center_d.webp`
: `soft watercolor illustration, gentle pastel palette, clean small commercial building used as counseling center, basic signage, tidy entrance with one potted plant, simple but maintained exterior, partly cloudy sky, neighborhood therapy office, 4:3 aspect ratio`

(3) `center_c.webp`
: `soft watercolor illustration, gentle pastel palette, two-story counseling center building, bright clean exterior, visible garden area with bench, professional signage, flowers along pathway, blue sky with white clouds, established community center, 4:3 aspect ratio`

(4) `center_b.webp`
: `soft watercolor illustration, gentle pastel palette, modern three-story healing center, LED illuminated sign, decorative fountain at entrance, landscaped gardens, glass entrance lobby visible, contemporary architecture, sunset golden hour lighting, prestigious therapy center, 4:3 aspect ratio`

(5) `center_a.webp`
: `soft watercolor illustration, gentle pastel palette, magnificent lighthouse-themed healing center, four-story modern building with lighthouse tower element on roof, beacon light glowing warmly, beautiful rooftop garden visible, large welcoming entrance with glass canopy, golden hour lighting, established prestigious center called Light of Hearts, 4:3 aspect ratio`

(6) `center_s.webp`
: `soft watercolor illustration, gentle pastel palette, magnificent lighthouse-inspired modern healing center, glowing beacon tower element, rooftop garden visible, three connected wings for different centers (adult, child, infant), glass and warm wood architecture, starry twilight sky, golden light emanating from windows, the ultimate integrated developmental healing center, 4:3 aspect ratio`
...
: `circular badge icon, golden border, speech bubble with heart symbol in center, first counseling session achievement, warm colors, game achievement style, 1:1 square, clean transparent background`

(2) `badge_first_discharge.webp`
: `circular badge icon, golden border, open door with sunlight rays, first patient discharge achievement, teal and gold colors, game achievement style, 1:1 square, clean transparent background`

(3) `badge_facility_master.webp`
: `circular badge icon, silver border, wrench and building symbol, all facilities built achievement, blue and silver, game achievement style, 1:1 square, clean transparent background`

(4) `badge_counselor_team.webp`
: `circular badge icon, golden border, three people silhouettes in circle, full counselor team achievement, purple and gold, game achievement style, 1:1 square, clean transparent background`

(5) `badge_reputation_a.webp`
: `circular badge icon, golden border, lighthouse with shining beacon, A-rank reputation achievement, gold and teal, game achievement style, 1:1 square, clean transparent background`

(6) `badge_100_treats.webp`
: `circular badge icon, golden border, number 100 with star, hundred treatments achievement, warm gold, game achievement style, 1:1 square, clean transparent background`

(7) `badge_zero_crisis.webp`
: `shield badge icon, silver border, shield with checkmark, zero crisis record achievement, blue and silver, game achievement style, 1:1 square, clean transparent background`

(8) `badge_all_issues.webp`
: `circular badge icon, rainbow border, eight-pointed star, all issue types treated achievement, rainbow colors, game achievement style, 1:1 square, clean transparent background`

(9) `badge_economy_master.webp`
: `circular badge icon, golden border, coin stack with crown, financial mastery achievement, gold and amber, game achievement style, 1:1 square, clean transparent background`

(10) `badge_lighthouse_guardian.webp`
: `shield badge icon, golden border, lighthouse on cliff with rainbow, ultimate guardian achievement, gold purple and teal, premium game achievement style, 1:1 square, clean transparent background`

### 2) 아동 업적 (8개)

(11) `badge_first_child_discharge.webp`
: `circular badge icon, golden border, child figure with butterfly wings spreading, first child discharge, warm yellow and teal, game achievement style, 1:1 square, clean transparent background`

(12) `badge_play_power.webp`
: `circular badge icon, silver border, toy blocks with sparkle, play therapy mastery, yellow and purple, game achievement style, 1:1 square, clean transparent background`

(13) `badge_parent_partner.webp`
: `circular badge icon, golden border, parent and child hands holding together, parent partnership, green and gold, game achievement style, 1:1 square, clean transparent background`

(14) `badge_school_expert.webp`
: `circular badge icon, silver border, school building with star, school consultation expert, blue and silver, game achievement style, 1:1 square, clean transparent background`

(15) `badge_child_specialist.webp`
: `shield badge icon, golden border, child silhouette in protective circle, child specialist center, warm orange and gold, game achievement style, 1:1 square, clean transparent background`

(16) `badge_crisis_guardian.webp`
: `shield badge icon, golden border, shield protecting a small figure, crisis guardian for youth, red and gold, game achievement style, 1:1 square, clean transparent background`

(17) `badge_rehabilitation.webp`
: `circular badge icon, golden border, path leading to sunrise, rehabilitation success, orange and gold, game achievement style, 1:1 square, clean transparent background`

(18) `badge_precise_diagnosis.webp`
: `circular badge icon, silver border, magnifying glass with brain symbol, precise psychological assessment, purple and silver, game achievement style, 1:1 square, clean transparent background`

### 3) 영유아 업적 (8개)

(19) `badge_first_milestone.webp`
: `circular badge icon, golden border, baby footprint with star, first developmental milestone, soft green and gold, game achievement style, 1:1 square, clean transparent background`

(20) `badge_golden_time.webp`
: `shield badge icon, golden border, hourglass with golden sand and star, golden time guardian, gold and amber, game achievement style, 1:1 square, clean transparent background`

(21) `badge_developmental_miracle.webp`
: `circular badge icon, rainbow border, seedling growing into tree, developmental miracle achievement, green rainbow, premium game achievement style, 1:1 square, clean transparent background`

(22) `badge_parent_coach.webp`
: `circular badge icon, golden border, hands guiding smaller hands, parent coaching mastery, warm orange and gold, game achievement style, 1:1 square, clean transparent background`

(23) `badge_integration_master.webp`
: `shield badge icon, rainbow border, three interconnected circles (representing 3 centers), integration master, rainbow with gold, premium game achievement style, 1:1 square, clean transparent background`

(24) `badge_voucher_expert.webp`
: `circular badge icon, golden border, government voucher document with checkmark, voucher program expert, blue and gold, game achievement style, 1:1 square, clean transparent background`

(25) `badge_stress_resolver.webp`
: `circular badge icon, silver border, storm cloud turning into sunshine, parent stress resolver, blue to yellow gradient, game achievement style, 1:1 square, clean transparent background`

(26) `badge_no_dispute.webp`
: `shield badge icon, golden border, balanced scales with peace symbol, zero dispute center, gold and green, game achievement style, 1:1 square, clean transparent background`
...
: `soft watercolor illustration, gentle pastel palette, 16:9, parent/guardian visiting counseling center lobby, concerned expression, talking to receptionist, warm interior lighting, family support theme, gentle atmosphere`

(2) `event_media_coverage.webp`
: `soft watercolor illustration, gentle pastel palette, 16:9, journalist with camera crew outside counseling center, center staff at entrance, media spotlight scene, mix of nervous and proud atmosphere, professional`

(3) `event_counselor_burnout.webp`
: `soft watercolor illustration, gentle pastel palette, 16:9, therapist sitting alone in empty office at night, head in hands, dim desk lamp only light source, stack of case files, compassion fatigue moment, empathetic and respectful depiction`

(4) `event_patient_conflict.webp`
: `soft watercolor illustration, gentle pastel palette, 16:9, two patients in group room with tense body language, therapist mediating between them, abstract tension lines in air, professional conflict resolution scene, not violent`

(5) `event_donation.webp`
: `soft watercolor illustration, gentle pastel palette, 16:9, generous donor presenting oversized check or gift to smiling center director, staff clapping in background, lobby with banner, warm grateful celebration atmosphere`

### 2) 아동 이벤트 (6개)

(6) `event_teacher_request.webp`
: `soft watercolor illustration, gentle pastel palette, 16:9, school teacher at counseling center meeting with therapist, concerned expression, student file on table, school-center collaboration scene, professional warm`

(7) `event_parent_anxiety.webp`
: `soft watercolor illustration, gentle pastel palette, 16:9, worried parent in waiting room, fidgeting hands, looking at phone anxiously, therapist approaching with reassuring gesture, parent support moment`

(8) `event_child_friendship.webp`
: `soft watercolor illustration, gentle pastel palette, 16:9, two children in center hallway discovering they enjoy same hobby, sharing stickers or drawing together, spontaneous friendship moment, bright cheerful`

(9) `event_sns_criticism.webp`
: `soft watercolor illustration, gentle pastel palette, 16:9, staff member looking at phone screen with worried expression, abstract negative comment bubbles floating from screen, other staff offering support, online criticism scene`

(10) `event_academic_invitation.webp`
: `soft watercolor illustration, gentle pastel palette, 16:9, therapist receiving formal invitation letter at desk, academic conference poster visible, proud excited expression, career growth moment`

(11) `event_abuse_suspicion.webp`
: `soft watercolor illustration, gentle pastel palette, 16:9, therapist in deep contemplation at desk, child's drawing on table showing concerning content, phone nearby (for reporting), heavy moral responsibility moment, respectful serious tone, no explicit abuse depiction`

### 3) 영유아 이벤트 (6개)

(12) `event_gov_funding.webp`
: `soft watercolor illustration, gentle pastel palette, 16:9, government official presenting funding document to center director, handshake scene, official letterhead visible, professional partnership, positive support moment`

(13) `event_parent_burnout.webp`
: `soft watercolor illustration, gentle pastel palette, 16:9, exhausted parent dozing in waiting room chair, baby bag on floor, therapist bringing warm tea, empathetic caregiver fatigue scene, tender support moment`

(14) `event_dev_assessment.webp`
: `soft watercolor illustration, gentle pastel palette, 16:9, clinical psychologist conducting developmental assessment with toddler, colorful testing materials on table, parent observing from side, professional assessment scene`

(15) `event_sibling_jealousy.webp`
: `soft watercolor illustration, gentle pastel palette, 16:9, older sibling standing in center hallway looking sad while parent carries younger sibling into therapy room, loneliness moment, tender family dynamics scene`

(16) `event_milestone_celebration.webp`
: `soft watercolor illustration, gentle pastel palette, 16:9, center staff and parents celebrating a child's developmental milestone, small party with balloons, toddler clapping happily, joyful achievement celebration`

(17) `event_waitlist_complaint.webp`
: `soft watercolor illustration, gentle pastel palette, 16:9, parent at reception desk expressing frustration about waiting list, receptionist showing apologetic gesture, queue of families in background, service demand scene`
...
(1) `intro_page1.webp`
: `cinematic watercolor illustration, 16:9, bird's eye view of a small struggling counseling center in a busy city, people walking past with heavy shadows (representing emotional weight), one person stops and looks at the center's dim sign, dawn sky suggesting new beginning, establishing shot, Korean city atmosphere`

(2) `intro_page2.webp`
: `cinematic watercolor illustration, 16:9, abstract metaphor of emotional mass (EM), figure carrying heavy dark sphere on shoulders representing psychological burden, same figure becoming lighter as sphere shrinks through therapy, gradient from dark red to bright teal, emotional weight concept visualization`

(3) `intro_page3.webp`
: `cinematic watercolor illustration, 16:9, evidence-based therapy showcase, split panel showing CBT whiteboard, psychodynamic therapy couch, DBT skills worksheet, family therapy circle, each panel glowing with different color, professional healing methods visualization, scientific and warm`

(4) `intro_page4.webp`
: `cinematic watercolor illustration, 16:9, counseling center growing from small office to magnificent lighthouse building, timeline progression from left to right, more patients being healed, more staff joining, ending with the center shining like a beacon, growth and hope journey, golden hour lighting`
...
(1) `ending_a.webp`
: `cinematic watercolor illustration, 16:9, ending scene titled Friend of Children, group of diverse children and teenagers standing happily in front of the counseling center, some waving, some holding hands, therapists and parents in background smiling, cherry blossom petals falling, warm golden sunset, emotional triumphant atmosphere`

(2) `ending_s.webp`
: `cinematic watercolor illustration, 16:9, ultimate ending scene titled Light of Integrated Healing, magnificent three-wing center building glowing like lighthouse at twilight, three colored beams (teal for adult, amber for child, pink for infant) converging into single bright light at top, crowds of healed people gathered in front, fireworks and flower petals, starry sky, emotional peak moment of the game`
...
: `soft watercolor illustration, gentle pastel palette, 16:9, empty dark counseling room, chairs stacked, lights off, FOR LEASE sign on window, last staff member carrying box of belongings walking out, rainy gray atmosphere, melancholic but not hopeless, sense that one could try again`

(2) `gameover_trust_lost.webp`
: `soft watercolor illustration, gentle pastel palette, 16:9, counseling center with patients walking away in a line toward the horizon, building still standing but empty, wilting plants at entrance, cloudy overcast sky, loss of trust atmosphere, bittersweet, center alone, melancholic but respectful`
...
(1) `icon_gold.webp`
: `game UI icon, shiny golden coin with heart engraved in center, metallic shine, warm glow effect, pixel-art adjacent style, clean transparent background, 1:1 square, game currency icon`

(2) `icon_ap.webp`
: `game UI icon, bright blue lightning bolt with sparkle effects, energetic action point symbol, electric glow, pixel-art adjacent style, clean transparent background, 1:1 square, game energy icon`

(3) `icon_reputation.webp`
: `game UI icon, golden five-pointed star with laurel wreath around it, prestige and reputation symbol, warm golden glow, pixel-art adjacent style, clean transparent background, 1:1 square, game reputation icon`
